...
class LoadHuffmanTables
  ...
  def distance_table
    load_huffman_tables unless @distance_table

    @distance_table
  end

  def literal_length_table
    load_huffman_tables unless @literal_length_table
  ...
  def load_huffman_tables
    ...
    @code_length_table = load_code_length_table(num_code_length_codes)
    @literal_length_table = load_literal_length_table(num_literal_length_codes)
    @distance_table = load_distance_table(num_distance_codes)
  end

  def load_code_length_table(num_code_length_codes)
  ...
  def load_literal_length_table(num_literal_length_codes)
  ...
  def load_distance_table(num_distance_codes)
